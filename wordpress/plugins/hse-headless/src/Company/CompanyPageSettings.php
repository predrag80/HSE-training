...
final class CompanyPageSettings {
	...
	public static function enqueue_admin_assets( $hook_suffix ): void {
		...
		wp_enqueue_media();
		wp_enqueue_style( 'hse-company-admin', plugins_url( 'assets/company-admin.css', $plugin_file ), array(), '0.17.0' );
		wp_enqueue_script( 'hse-company-admin', plugins_url( 'assets/company-admin.js', $plugin_file ), array(), '0.17.0', true );
		wp_localize_script(
			'hse-company-admin',
			'hseCompanyAdmin',
			array(
