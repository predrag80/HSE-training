...
const consultingUi = {
	en: {
		metaTitle: 'Browse HSE Talent | HSE Training',
		...
		heroEyebrow: 'Professional HSEQ expertise', heroTitle: 'Browse HSE Talent', heroScroll: 'Scroll to consulting services',
		...
		industriesEyebrow: 'Industry experience', industriesTitle: 'HSE Directory only connects the parties and is not responsible for their agreements.',
		industriesIntro: 'Professionals upload qualifications, certifications, memberships, and their field of expertise. These submissions are reviewed by our administrators.',
		industries: [
		...
		experienceKicker: 'Operational knowledge', experienceTitle: 'Join us. Grow the network. Create more opportunities.',
		experienceText: 'Companies can search, filter, and contact qualified specialists; professionals can showcase their experience, certifications and availability.',
		...
		qualificationsLead: 'Built by HSE professionals in Perth, Western Australia,',
		qualificationsText: 'we understand the challenges of finding experienced personnel at short notice.',
		ctaEyebrow: 'Planning a project or strengthening your HSE team?', ctaTitle: 'Let’s discuss the expertise you need.', ctaLabel: 'Browse HSE Talent',
	},
	sr: {
		metaTitle: 'Pregledajte HSE stručnjake | HSE Training',
		...
		heroEyebrow: 'Profesionalna HSEQ stručnost', heroTitle: 'Pregledajte HSE stručnjake', heroScroll: 'Pređite na konsultantske usluge',
		...
		industriesEyebrow: 'Iskustvo u industriji', industriesTitle: 'HSE Directory samo povezuje strane i nije odgovoran za njihove međusobne dogovore.',
		industriesIntro: 'Stručnjaci unose svoje kvalifikacije, sertifikate, članstva i oblasti stručnosti. Naši administratori pregledaju dostavljene podatke.',
		industries: [
		...
		experienceKicker: 'Operativno znanje', experienceTitle: 'Pridružite nam se. Proširimo mrežu. Stvorimo više prilika.',
		experienceText: 'Kompanije mogu da pretražuju, filtriraju i kontaktiraju kvalifikovane stručnjake, dok profesionalci mogu da predstave svoje iskustvo, sertifikate i dostupnost.',
		...
		qualificationsLead: 'HSE Directory su kreirali HSE stručnjaci u Pertu, u Zapadnoj Australiji,',
		qualificationsText: 'koji razumeju izazov pronalaženja iskusnog osoblja u kratkom roku.',
		ctaEyebrow: 'Planirate projekat ili jačate svoj HSE tim?', ctaTitle: 'Razgovarajmo o stručnosti koja vam je potrebna.', ctaLabel: 'Pregledajte HSE stručnjake',
	},
} as const;
